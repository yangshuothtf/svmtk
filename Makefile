...
svm_learn_hideo: svm_learn_main.o svm_learn.o svm_common.o tree_manager.o tree_kernel.o semantic_kernel.o svm_hideo.o 
	$(LD) $(LFLAGS) svm_learn_main.o svm_learn.o svm_common.o tree_manager.o tree_kernel.o semantic_kernel.o svm_hideo.o -o svm_learn $(LIBS)

svm_learn_loqo: svm_learn_main.o svm_learn.o svm_common.o tree_manager.o tree_kernel.o semantic_kernel.o svm_loqo.o loqo
	$(LD) $(LFLAGS) svm_learn_main.o svm_learn.o svm_common.o tree_manager.o tree_kernel.o semantic_kernel.o svm_loqo.o pr_loqo/pr_loqo.o -o svm_learn $(LIBS)
...
semantic_kernel.o: semantic_kernel.c svm_common.h kernel.h
	$(CC) -c $(CFLAGS) semantic_kernel.c -o semantic_kernel.o 

svm_learn_main.o: svm_learn_main.c svm_learn.h svm_common.h 
	$(CC) -c $(CFLAGS) svm_learn_main.c -o svm_learn_main.o 


svm_classify: svm_classify.o svm_common.o tree_manager.o tree_kernel.o semantic_kernel.o
	$(LD)  $(LFLAGS) svm_classify.o svm_common.o tree_kernel.o tree_manager.o semantic_kernel.o -o svm_classify $(LIBS)
